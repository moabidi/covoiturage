...
function InitAdresse(){
    $('#annonce_idPays').live('change',function(){
        var select = $(this);
        var idPays = select.val();
        var xmlRquest = $.ajax({
            type: "post",
            url: "/symfony_2.3.4/symfony_2.3.4/wwwroot/web/app_dev.php/list/gouvernorats",
            data: {idPays: idPays}
        });
    ...
    $('#annonce_idGouvernorat').live('change',function(){
        var select = $(this);
        var idPays = select.val();
        var xmlRquest = $.ajax({
            type: "post",
            url: "/symfony_2.3.4/symfony_2.3.4/wwwroot/web/app_dev.php/list/delegations",
            data: {idPays: idPays}
        });
        xmlRquest.done(function(msg){
            var patt1 = /(<select)+(.)+(<\/select>)+/i;
            ...
            if( resultOption){
                ...
                $('select#annonce_idDelegation').chosen({
                    disable_search_threshold: 10
                });
            }
        });
    ...
    $('#annonce_idDelegation').live('change',function(){
        var select = $(this);
        var idPays = select.val();
        var xmlRquest = $.ajax({
            type: "post",
            url: "/symfony_2.3.4/symfony_2.3.4/wwwroot/web/app_dev.php/list/locations",
            data: {idPays: idPays}
        });
        xmlRquest.done(function(msg){
            var patt1 = /(<select)+(.)+(<\/select>)+/i;
